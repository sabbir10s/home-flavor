        ...
        <div className='flex mt-7 justify-center'>
            ...
            <div className="w-full max-w-xs">
                <form onSubmit={handleLogin} className="bg-white shadow-lg border-[1.5px] rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div className="mb-4">
                        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700  leading-tight focus:outline-none focus:shadow-outline" name="email" type="email" placeholder="Your email" />
                    </div>
                    <div className="mb-4">
